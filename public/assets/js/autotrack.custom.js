...
;(function() {
  ...
  function x(a, b) {
    if (a && 1 == a.nodeType && b) {
      if ('string' == typeof b || 1 == b.nodeType) return a == b || y(a, b)
      if ('length' in b) for (var c = 0, d; (d = b[c]); c++) if (a == d || y(a, d)) return !0
    }
    return !1
  }
  function y(a, b) {
    if ('string' != typeof b) return !1
    if (w) return w.call(a, b)
  ...
  function A(a, b, c) {
    function d(a) {
      ...
      if (h.composed && 'function' == typeof a.composedPath)
        for (var e = a.composedPath(), f = 0, n; (n = e[f]); f++)
          1 == n.nodeType && x(n, b) && (d = n)
      else
        a: {
          if ((d = a.target) && 1 == d.nodeType && b)
            for (d = [d].concat(z(d)), e = 0; (f = d[e]); e++)
              if (x(f, b)) {
                d = f
                break a
              }
  ...
  function F(a) {
    ...
    if (E[a]) return E[a]
    D.href = a
    if ('.' == a.charAt(0) || '/' == a.charAt(0)) return F(D.href)
    var b = '80' == D.port || '443' == D.port ? '' : D.port,
      b = '0' == b ? '' : b,
      c = D.host.replace(C, '')
    return (E[a] = {
      hash: D.hash,
      ...
      hostname: D.hostname,
      href: D.href,
      origin: D.origin ? D.origin : D.protocol + '//' + c,
  ...
  function I(a, b) {
    ...
    this.g = function(a) {
      ...
      return c.b[c.b.length - 1].apply(null, [].concat(u(b)))
    }
    this.c ? a.set(b, this.g) : (a[b] = this.g)
  }
  function J(a, b) {
    b = a.a.indexOf(b)
    ;-1 < b && (a.a.splice(b, 1), 0 < a.a.length ? K(a) : a.h())
  }
  function K(a) {
    a.b = []
    for (var b, c = 0; (b = a.a[c]); c++) {
      var d = a.b[c - 1] || a.f.bind(a.context)
      a.b.push(b(d))
    }
  }
  I.prototype.h = function() {
    ...
    ;-1 < a &&
      (G.splice(a, 1), this.c ? this.context.set(this.i, this.f) : (this.context[this.i] = this.f))
  }
  function L(a) {
    var b = history,
      c = G.filter(function(c) {
        return c.context == b && c.i == a
      })[0]
    c || ((c = new I(b, a)), G.push(c))
    return c
  }
  ...
  var S = { s: 1, u: 2, v: 3, A: 4, B: 5, m: 6, C: 7, D: 8, o: 9, w: 10 },
  ...
  function V(a, b) {
    ...
    window.addEventListener &&
      ...
      this.a.events.forEach(function(a) {
        c.c[a] = A(a, c.a.linkSelector, c.f)
      }))
  }
  V.prototype.f = function(a, b) {
    var c = this
    if (this.a.shouldTrackOutboundLink(b, F)) {
      var d = b.getAttribute('href') || b.getAttribute('xlink:href'),
        ...
        h = N({}, this.a.fieldsObj, O(b, this.a.attributePrefix)),
        f = M(e, h, this.b, this.a.hitFilter, b, a)
      if (
    ...
    setTimeout(function() {
      ...
      c != d &&
        ...
        (b || a.a.trackReplaceState) &&
          a.g.send('pageview', M({ transport: 'beacon' }, a.a.fieldsObj, a.g, a.a.hitFilter)))
    }, 0)
  }
